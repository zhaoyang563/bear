    ...
    <div class="collectionIndex" @click.stop="hideSelectToast">
                ...
                <div class="mainView-topView-flex-left">
                    ...
                    <my-select 
                        ...
                        <div class="mainView-topView-btnview">
                            ...
                            <!-- <el-button type="primary" class="add-sensor" @click="createOrUpdateSensor('add')">添加读数仪</el-button> -->
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="toastview" v-if="isShowSensorDetail">
            <div class="toast-main-view">
                <div class="toast-main-view-close" @click="isShowSensorDetail = false">
                    <i class="el-icon-close"></i>
                </div>
                <div class="main-view-detail">
                    <p class="main-view-detail-title">{{updateOrAddReadMeteTitle}}</p>
...
export default {
    ...
    methods: {
        ...
        hideIsShowSensorDetail() {
            ...
            this.sensorInfo.sensorCode = ''
            this.sensorInfo.sensorPassword = ''
        },
        createOrUpdateSensor(type) {
            ...
            if(type == 'update') {
                ...
                this.updateOrAddReadMeteTitle = '修改读数仪信息'
            }else {
                this.sensorInfo.sensorCode = ''
                this.updateOrAddReadMeteTitle = '新增读数仪信息'
            }
        },
        updateOrAddReadMete() {
    ...
    watch: {
		$route (to, from) {
			if(to.name == from.name && to.query.sim != from.query.sim) {
                 // 赋值来自路由的参数
                 console.log('重新加载')
                this.listReadMeterByUserId()
			}
